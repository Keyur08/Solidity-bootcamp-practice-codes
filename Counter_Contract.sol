...
contract Example {
    ...
    constructor(uint initial_value, string memory initial_description) {
        owner = msg.sender;
        counter = Counter(initial_value, initial_description);
    }
    ...
    // New function to get the counter description
